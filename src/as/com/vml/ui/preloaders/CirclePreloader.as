package com.vml.ui.preloaders
{
	...
	public class CirclePreloader extends Sprite
	{
		...
		public function CirclePreloader(slices:int = 12, radius:int = 6, bgColor:uint = 0x666666)
		{
			super();
			this.slices = slices;
			this.radius = radius;
		...
		private function getSlice():Shape
		{
			...
			slice.graphics.beginFill(bgColor);
			slice.graphics.drawRoundRect(-1, 0, (radius * .33), radius, (radius * .33), (radius * .33));
